...
interface ProductsFilterProps {
  products: Product[]
  filterChoice: (filter: { category: string; search: string }) => void
}

function ProductsFilter({ products, filterChoice }: ProductsFilterProps) {
  ...
  const sendFilterChoice = () => {
    console.log('filter send --', selectedCategory, searchQuery)
  ...
  return (
    <div className={s.productFilterContainer}>
      ...
      {/* <button type="button" onClick={sendFilterChoice}>
        filter
      </button> */}
